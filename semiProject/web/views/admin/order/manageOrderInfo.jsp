     ...
     <section>
          ...
          <div class="content" style="display:flex">
              ...
              <div class="main"> 
                  ...
                  <div id="user_btn">
                      <button type="button">결제 내역</button>
                      <button type="button" class="choice2">주문 접수 내역</button>
                  </div>
                  <div id="user_content">
                      ...
                      <table id="output_table" class="pa" border=1>
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>user01</td>
                                  <td>00,000원</td>
                                  <td><button class="whitebtn">자세히 보기</button></td><!--클릭 시 결제세부정보(manageOrderInfoDetail.jsp) 화면으로 이동-->
                              </tr>
                          </tbody>
                      </table>
                  </div>
