...
<section>
    ...
    <h1 class="searchp" style="font-family: 'Noto Sans KR';font-size: 30px;">세일</h1>
    <div class="ql_v_top">
        <table class="qlv_ct" border="1" style="border-collapse:collapse">
            <tr>
                <th style="padding:7px; cursor:pointer; width:50px;">전체</th>
                <th style="padding:7px; cursor:pointer; width:50px;">소파</th>
                <th style="padding:7px; cursor:pointer; width: 50px;">침대</th>
                <th style="padding:7px; cursor:pointer; width: 50px;">옷장</th>
                <th style="padding:7px; cursor:pointer; width:50px;">서랍</th>
                <th style="padding:7px; cursor:pointer; width:50px;">의자</th>
            </tr>
        </table>
    <div id="sp_v_top">
