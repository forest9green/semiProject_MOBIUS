...
public class User {
	...
	public User(String userId, String userPwd, String userName, String email, int emailSmsCk, String cellPhone,
			int phoneSmsCk, String phone, Date joinDate, Date recentDate, int mileage) {
		super();
		this.userId = userId;
